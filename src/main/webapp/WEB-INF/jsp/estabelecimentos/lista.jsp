...
<body>
	...
	<form id="addForm" action="" method="post">
		<label for="nome">Nome:</label> <input type="text"
			name="estabelecimento.nome" id="nome" /> <label for="endereco">Endereco:</label>
		<input type="text" name="estabelecimento.endereco" id="endereco" /> <label
			for="estacionamento">Estacionamento:</label> <select
			name="estabelecimento.temEstacionamento" id="estacionamento">
